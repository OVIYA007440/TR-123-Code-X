      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center gap-6">
            <Avatar className="h-20 w-20 bg-accent">
              <AvatarFallback className="text-accent-foreground text-2xl">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Immediate notifications for high-risk cases</p>
            </div>
            <Switch defaultChecked />
          </div>
          <Separator />
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Receive automated weekly performance summaries</p>
            </div>
            <Switch />
          </div>
